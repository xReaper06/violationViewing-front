    ...
    <div class="card shadow-lg p-3 mb-5 bg-white rounded">
        <div class="ms-md-5">
            ...
            <ul class="list-unstyled">
                <li>
                    <p class="fs-6">Wear Your Helmet:</p>
                    <p class="text-muted">Always wear a helmet when riding a motorcycle.<br> Ensure that your helmet is properly fastened for maximum protection.</p>
                </li>
                <li>
                    <p class="fs-6">Stay Alert on the Road:</p>
                    <p class="text-muted">Be attentive to your surroundings.<br> Avoid distractions such as mobile phones while driving.</p>
                </li>
                <li>
            <p class="fs-6">No Racing on the Road:</p>
            <p class="text-muted">Roads are not race tracks; prioritize safety over speed. <br> Follow speed limits and traffic regulations.</p>
          </li>
          <li>
            <p class="fs-6">Avoid Driving Under the Influence:</p>
            <p class="text-muted">Never drive under the influence of alcohol or drugs. <br> Plan for alternative transportation if you are impaired.</p>
          </li>
          <li>
            <p class="fs-6">Carry Your Documents:</p>
            <p class="text-muted">Always have your driver's license, vehicle registration, and insurance. <br> Keep these documents readily accessible in your vehicle.</p>
          </li>
          <li>
            <p class="fs-6">Prevent Road Rage:</p>
            <p class="text-muted">Stay calm and composed while driving. <br> Avoid aggressive behavior and respect other road users.</p>
          </li>
          <li>
            <p class="fs-6">Remember, adhering to traffic safety rules not only protects you but also contributes to the overall safety of everyone on the road. Stay responsible and prioritize the well-being of yourself and others.</p>
          </li>
            </ul>
